...
export const careerProjects: careerProjectsProps[] = [
  ...
  },
  {
    ...
    image: "./imobille.webp",
    competences: ["NextJS", "SEO", "Typescript", "Context API"],
    year: 2022,
  },
  {
    company: "GrupoW | Softwares para internet",
  ...
  },
  {
    ...
    competences: ["WordPress", "PHP", "Pixel", "Yoast SEO"],
    year: 2021,
  },
  {
    company: "Freelancer",
    ...
    image: "./gardini.webp",
    competences: ["ReactJS", "Typescript", "Styled Components", "NodeJS"],
    year: 2023,
  },
];
